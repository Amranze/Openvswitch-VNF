 ...
 */
	...
	/* OFPT 1.2+ (4): struct ofp12_experimenter_stats_header, uint8_t[8][].*/
	OFPRAW_OFPT_EXPERIMENTER,
/* kahina   changment effectue dans built-aux/extract-ofp-msg changer OFPT_VENDOR 4 with 70 */
...
enum ofptype {
	...
	/* kahina  */
	OFPTYPE_EXPERIMENTER,       /* OFPRAW_OFPT_EXPERIMENTER. */
