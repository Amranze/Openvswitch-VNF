               ...
               size_t n_upcalls)
{
     ...
     * datapath. */
    VLOG_WARN("kahina ......handl_ upcall for nupcall  %d",0);
    n_ops = 0;
    for (i = 0; i < n_upcalls; i++) {
     ...
     */
    VLOG_WARN("kahina ......handle upcall fin for   %d",0);
    n_opsp = 0;
    for (i = 0; i < n_ops; i++) {
        ...
        VLOG_WARN("kahina handle upcall  : copie ops-->opsp    %d",0);
    }
    ...
    VLOG_WARN("kahina ......handle_upcall fin   %d",0);
}
    ...
    OVS_REQUIRES(ukey->mutex)
{
    ...
    VLOG_WARN("kahina . revalidate_ukey %d",0);
